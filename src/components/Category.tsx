...
export const Category: React.FC = (): JSX.Element => {
  ...
  return (
    <aside
      ...
      } z-[12] category overflow-hidden border-0 lg:border-r-[1px] border-border border-solid lg:animate-none pt-4 w-11/12 sm:w-1/2 md:w-2/6 lg:w-auto top-0 left-0 -translate-x-full lg:translate-x-0 ease-in-out absolute lg:relative xl:basis-1/5 lg:basis-1/4 flex h-screen lg:min-w-[300px] bg-background lg:bg-inherit flex-col`}
    >
